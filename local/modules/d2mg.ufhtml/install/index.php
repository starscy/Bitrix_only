...
class d9mg_ufhtml extends CModule
{
	var $MODULE_ID = "d9mg.ufhtml";
	var $MODULE_VERSION;
	...
	function InstallDB()
	{
		RegisterModule("d9mg_ufhtml");
		RegisterModuleDependences("main", "OnUserTypeBuildList", "d9mg_ufhtml", "CCustomTypeHtml", "GetUserTypeDescription");
	...
	{
		UnRegisterModuleDependences("main", "OnUserTypeBuildList", "d9mg_ufhtml", "CCustomTypeHtml", "GetUserTypeDescription");
		UnRegisterModule("d9mg_ufhtml");
